...
class MainActivity : AppCompatActivity() {
        ...
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            permissions.entries.forEach{
                ...
                if(isGranted) {
                    Toast.makeText(
                        this@MainActivity,
                        "Permission granted for accessing storage files.",
                        Toast.LENGTH_LONG
                    ).show()
                }else{
                    if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE){
                        Toast.makeText(this@MainActivity,"Permission denied for accessing storage files.",Toast.LENGTH_LONG).show()
                    }
                }
            }
        }
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val smallBtn: ImageButton = brushDialog.findViewById(R.id.ib_smallBrush)
        smallBtn.setOnClickListener {
            drawingView?.setSizeForBrush(10.toFloat())
            brushDialog.dismiss()
        }
        val mediumBtn: ImageButton = brushDialog.findViewById(R.id.ib_mediumBrush)
        mediumBtn.setOnClickListener {
            drawingView?.setSizeForBrush(20.toFloat())
            brushDialog.dismiss()
        }
        val largeBtn: ImageButton = brushDialog.findViewById(R.id.ib_largeBrush)
...
/* Working in Android Studio Virtual Device
But sharing and storing error in Physical Device
 */
